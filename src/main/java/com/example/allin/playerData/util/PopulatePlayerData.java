  ...
  public void populate() throws IOException {
    for (int id : ids) {
      ...
      while (stats.get(i).getElementsByTag("td").get(0).text().equals("TM") == false) {
        ...
        PlayerData playerData = new PlayerData(player, gameDate, OpposingTeam.valueOf(opposingTeam), points, minutes, fieldGoalsMade, threePointersMade, freeThrowsMade, rebounds, assists, steals, blocks, turnovers, personalFouls);
