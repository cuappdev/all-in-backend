...
public class Application {
        ...
        public CommandLineRunner populatePlayers(PlayerRepo playerRepo, PlayerDataRepo playerDataRepo) {
                return (args) -> {
                        ...
                        // String baseUrl =
                        // "root/all-in-backend/src/main/resources/static/images/players/";
                        ...
                        Player nazir_williams = new Player("Nazir", "Williams", new Position[] { Position.Guard }, 1,
                                        "6'3", 180,
                                        "Nyack, N.Y.",
                                        "South Kent School", baseUrl + "nazir.jpeg");
                        ...
                        Player hayden_franson = new Player("Hayden", "Franson", new Position[] { Position.Forward }, 10,
                                        "6'8", 218,
                                        "American Fork, Utah",
                                        "American Fork HS", baseUrl + "hayden.jpeg");
