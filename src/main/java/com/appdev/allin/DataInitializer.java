...
import com.appdev.allin.scrapers.PopulatePlayerData;
...
public class DataInitializer {
        ...
        private void populatePlayers() {
                ...
                Player nazir_williams = new Player(
                                "Nazir",
                                "Williams",
                                new Position[] { Position.GUARD },
                                1,
                ...
                Player sean_hansen = new Player(
                                ...
                                "Ramsey HS",
                                baseUrl + "sean.jpeg");
                Player cooper_noard = new Player(
                                "Cooper",
                                "Noard",
                                new Position[] { Position.GUARD },
                                31,
                ...
                Player ak_okereke = new Player(
                                ...
                                "Clovis North HS",
                                baseUrl + "ak.jpeg");
                Player keller_boothby = new Player(
                                "Keller",
                                "Boothby",
                                new Position[] { Position.FORWARD },
                                15,
                ...
                Player jake_fiegen = new Player(
                                ...
                                "New Trier HS",
                                baseUrl + "jake.jpeg");
                Player jacob_beccles = new Player(
                                "Jacob",
                                "Beccles",
                                new Position[] { Position.GUARD },
                                5,
                ...
                Player chris_cain = new Player(
                                ...
                                "Pine Bush HS",
                                baseUrl + "chris.jpeg");
                Player evan_williams = new Player(
                                "Evan",
                                "Williams",
                                new Position[] { Position.FORWARD },
                                0,
                ...
                Player dj_nix = new Player(
                                ...
                                "Cannon School",
                                baseUrl + "dj.jpeg");
                Player ryan_kiachian = new Player(
                                "Ryan",
                                "Kiachian",
                                ...
                                baseUrl + "ryan.jpeg");
                Player darius_ervin = new Player(
                                "Darius",
                                "Ervin",
                                new Position[] { Position.GUARD },
                                14,
                                ...
                                baseUrl + "darius.jpeg");
                Player hayden_franson = new Player(
                                "Hayden",
                                "Franson",
                                new Position[] { Position.FORWARD },
                                10,
