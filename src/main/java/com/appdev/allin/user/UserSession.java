...
// public static UserSession createSession(String firebaseIdToken, String
// deviceToken, EntityManager entityManager) {
// try {
// FirebaseToken decodedToken =
// FirebaseAuth.getInstance().verifyIdToken(firebaseIdToken);
// String firebaseUid = decodedToken.getUid();

// User user = entityManager.createQuery("SELECT user from User user where
// user.firebaseUid = :firebaseUid", User.class)
