   ...
   public void populate() throws IOException {
       ...
       try {
           ...
           for (Element playerElement : playerElements) {
               ...
               String positionStr = extractText(playerElement, "div.sidearm-roster-player-position span.sidearm-roster-player-position-long-short.hide-on-medium");
               Position[] positions = extractPositionsFromString(positionStr);
  
               // Can do if we want player class
               // String playerClass = extractText(playerElement, "span.sidearm-roster-player-academic-year");
               ...
               Player player = new Player(firstName, lastName, positions, number, height, weight, hometown, highSchool, imageUrl);
