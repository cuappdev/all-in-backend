...
class ContractGeneratorTest {
  ...
  public void testGenerateContract() {
    ...
    System.out.println(
        "Epic Probability Threshold: " + ContractGenerator.EPIC_PROBABILITY_THRESHOLD);
    System.out.println(
    ...
    double common_alpha =
        (ContractGenerator.COMMON_PROB_UPPER_BOUND + ContractGenerator.COMMON_PROB_LOWER_BOUND)
            * (ContractGenerator.COMMON_PAYOUT_UPPER_BOUND
                + ContractGenerator.COMMON_PAYOUT_LOWER_BOUND)
            / 4.0;
    double rare_alpha =
        (ContractGenerator.RARE_PROB_UPPER_BOUND + ContractGenerator.RARE_PROB_LOWER_BOUND)
            * (ContractGenerator.RARE_PAYOUT_UPPER_BOUND
                + ContractGenerator.RARE_PAYOUT_LOWER_BOUND)
            / 4.0;
    double epic_alpha =
        (ContractGenerator.EPIC_PROB_UPPER_BOUND + ContractGenerator.EPIC_PROB_LOWER_BOUND)
            * (ContractGenerator.EPIC_PAYOUT_UPPER_BOUND
                + ContractGenerator.EPIC_PAYOUT_LOWER_BOUND)
            / 4.0;
    ...
    User user =
        new User("Tony", "akm99", "src/main/resources/static/images/users/default.jpg", 1000.0);
    Player player =
        new Player(
            "LeBron",
            "James",
